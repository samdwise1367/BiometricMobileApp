...
public class LocalDatabaseFragment extends BiometricsFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Toast.makeText(getContext(), String.valueOf(getid) + " is the userId", Toast.LENGTH_LONG);
        ...
        BioExampleActivity getBio = (BioExampleActivity)getActivity();
        getid = Integer.parseInt(getBio.getId());
    ...
    /**
     * Called when the enroll button is pressed in the Local D
     * atabase section.
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (verFinger == null) {
                            ...
                            if (verFinger.getUser().getId() == getid) {
                                int fingerNum = 1;
