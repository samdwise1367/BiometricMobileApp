 ...
 */
public class EnrollUpdate3 extends Activity {
    ...
    private void NextPage(View v) {
        ...
        if (sChildren != null) {
            ...
            InvestorPpty ppNew = new InvestorPpty(pp.get_userId(),
                    ...
                    pp.get_marital(),sChildren,sDisability,sSchStatus, sEducation, sHousehold, sSizeHousehold, pp.get_imageUrl(),pp.get_dateAdded(), pp.get_uniqueId(),
                    pp.get_accountType());
