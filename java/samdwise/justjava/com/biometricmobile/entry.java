...
public class entry extends Activity implements View.OnClickListener, LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[]{"Enroll Investor","Verification via User Id", "Verification via Biometrics","Track Location","View Tracked Location","Logout"};
