...
public class Enroll2 extends Activity {
   ...
   // private Spinner stateOfOrigin = null;
    ...
    //private String sStateOfOrigin = null;
    ...
    private void NextPage(View v) {
        ...
        smarital = marital.getSelectedItem().toString();
        //sStateOfOrigin = stateOfOrigin.getSelectedItem().toString().toString();
        if (sTel != null && !sTel.isEmpty() && scontAdd!= null) {
            ...
            InvestorPpty ppNew = new InvestorPpty(pp.get_userId(),pp.get_fname(), pp.get_mname(), pp.get_lname(),
                    ...
                    sTel, sEmail, sblood, smarital, blank, blank,
                    blank, blank, blank, blank,blank, pp.get_dateAdded(),blank,blank);
